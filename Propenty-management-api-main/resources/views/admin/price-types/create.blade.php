...
@section('title', __('admin.add_price_type'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ __('admin.add_price_type') }}</h3>
                ...
                <form action="{{ route('admin.price-types.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('listing_type') is-invalid @enderror" 
                                        ...
                                        <option value="both" {{ old('listing_type') == 'both' ? 'selected' : '' }}>
                                            {{ __('admin.both') }}
                                        </option>
                                    </select>
                                    @error('listing_type')
