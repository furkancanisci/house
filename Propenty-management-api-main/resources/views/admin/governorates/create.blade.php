...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">إضافة محافظة جديدة</h1>
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">معلومات المحافظة</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.governorates.store') }}" method="POST" id="governorateForm">
                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        سيتم إنشاء الرمز (slug) تلقائياً من الاسم الإنجليزي
                                    </small>
                                </div>
                            </div>
                        ...
                        <div class="form-group mb-0">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> حفظ المحافظة
                            </button>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <h6 class="text-primary">إرشادات الإدخال:</h6>
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            <i class="fas fa-check text-success"></i>
                            <strong>الاسم العربي:</strong> يجب أن يكون فريداً
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check text-success"></i>
                            <strong>الاسم الإنجليزي:</strong> يجب أن يكون فريداً
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-info text-info"></i>
                            <strong>الاسم الكردي:</strong> اختياري للدعم متعدد اللغات
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check text-success"></i>
                            <strong>الإحداثيات:</strong> اختيارية لتحديد الموقع
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check text-success"></i>
                            <strong>الحالة:</strong> تحكم في ظهور المحافظة
                        </li>
                    </ul>
                    
                    <hr>
                    
                    <h6 class="text-primary">أمثلة على المحافظات السورية:</h6>
                    <div class="small text-muted">
                        <div class="mb-1"><strong>دمشق</strong> - Damascus</div>
                        <div class="mb-1"><strong>حلب</strong> - Aleppo</div>
                        <div class="mb-1"><strong>حمص</strong> - Homs</div>
                        <div class="mb-1"><strong>اللاذقية</strong> - Latakia</div>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#name_en').on('input', function() {
        ...
        // This is just for preview - actual slug generation happens on server
        ...
        if (slug) {
            if (!$('#slug-preview').length) {
                $(this).parent().append('<small id="slug-preview" class="form-text text-info"></small>');
            }
            $('#slug-preview').text('الرمز المتوقع: ' + slug);
        } else {
            $('#slug-preview').remove();
        }
    });
