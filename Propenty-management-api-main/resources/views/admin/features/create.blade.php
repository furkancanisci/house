                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description in English">{{ old('description_en') }}</textarea>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description in Arabic" dir="rtl">{{ old('description_ar') }}</textarea>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description_ku') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description in Kurdish">{{ old('description_ku') }}</textarea>
