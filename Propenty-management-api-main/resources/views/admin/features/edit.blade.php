    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Feature: {{ $feature->name_en }}</h3>
            </div>
            ...
            <form method="POST" action="{{ route('admin.features.update', $feature) }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name_ar') is-invalid @enderror" 
                                       id="name_ar" name="name_ar" value="{{ old('name_ar', $feature->name_ar) }}" required dir="rtl">
                                @error('name_ar')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name_ku') is-invalid @enderror" 
                                       id="name_ku" name="name_ku" value="{{ old('name_ku', $feature->name_ku) }}" required>
                                @error('name_ku')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('category') is-invalid @enderror" 
                                       id="category" name="category" value="{{ old('category', $feature->category) }}" 
                                       placeholder="e.g., Interior, Exterior, Security">
                                @error('category')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                                <small class="form-text text-muted">Optional: Group similar features together</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                                       ...
                                       placeholder="e.g., fas fa-home, fas fa-car">
                                @error('icon')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                       id="sort_order" name="sort_order" value="{{ old('sort_order', $feature->sort_order ?? 0) }}" min="0">
                                @error('sort_order')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description in English">{{ old('description_en', $feature->description_en) }}</textarea>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description in Arabic" dir="rtl">{{ old('description_ar', $feature->description_ar) }}</textarea>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('description_ku') is-invalid @enderror" 
                                          ...
                                          placeholder="Optional description in Kurdish">{{ old('description_ku', $feature->description_ku) }}</textarea>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('admin.features.show', $feature) }}" class="btn btn-info">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <small class="d-block text-muted">{{ $feature->icon }}</small>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><i class="fas fa-check text-success"></i> Group similar features with categories</li>
                ...
                <div class="d-flex flex-wrap">
                    <span class="badge badge-info mr-1 mb-1">Interior</span>
                    <span class="badge badge-info mr-1 mb-1">Exterior</span>
                    <span class="badge badge-info mr-1 mb-1">Security</span>
                    <span class="badge badge-info mr-1 mb-1">Comfort</span>
                    <span class="badge badge-info mr-1 mb-1">Technology</span>
                </div>

                <h6 class="mt-3">Icon Examples:</h6>
                <div class="small">
                    <div><code>fas fa-home</code> - <i class="fas fa-home"></i> Home</div>
                    <div><code>fas fa-car</code> - <i class="fas fa-car"></i> Parking</div>
                    <div><code>fas fa-swimming-pool</code> - <i class="fas fa-swimming-pool"></i> Pool</div>
                    <div><code>fas fa-shield-alt</code> - <i class="fas fa-shield-alt"></i> Security</div>
                </div>
            </div>
        </div>
    </div>
